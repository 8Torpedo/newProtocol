...
int main (int argc, char *argv[])
{
    ...
    else if (strcmp(argv[1],"-r")==0)
    {
        ...
        {
            if ((strcmp(argv[5],"1")==0) && (strcmp(argv[6],"0")==0) && (strcmp(argv[7],"ee")==0))
            {
                /*DZIALA GITES*/
                printf("\n1 Command Start FIRE: ");
                frame[0]='S';
        ...
        {
            if ((strcmp(argv[5],"1")==0) && (strcmp(argv[6],"0")==0) && (strcmp(argv[7],"ea")==0))
            {
                /*DZIALA GITES*/
                printf("\n1 Command Stop FIRE: ");
                frame[0]='S';
        ...
        {
            if ((strcmp(argv[5],"1")==0) && (strcmp(argv[6],"0")==0) && (strcmp(argv[7],"ed")==0))
            {
                /*DZIALA GITES*/
                printf("\n1 Command How much WATER: ");
                frame[0]='H';
